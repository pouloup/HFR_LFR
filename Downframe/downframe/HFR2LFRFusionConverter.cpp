...
void HFR2LFRFusionConverter::processFrame()
{
	...
	calcOpticalFlowFarneback(m_prevFrame, m_currentFrame, prevToCurrOpticalFlowMap,
	...
	calcOpticalFlowFarneback(m_nextFrame, m_currentFrame, nextToCurrOpticalFlowMap,
		0.5,
		4,
		11,
		4,
