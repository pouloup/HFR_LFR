...
void HFR2LFRTemporalSobel::computeNormAndAngleOpticalFlow(const Mat & opticalFlowMap, Mat & opticalFlowNormMap, Mat & opticalFlowAngleMap)
{
...
void HFR2LFRTemporalSobel::getMotionBlurFilter(float norm, float angle, Mat & filter)
{
