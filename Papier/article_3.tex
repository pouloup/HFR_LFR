...
\begin{itemize}
    ...
    \item $I(x, y, t)$ : le pixel de coordonnée $(x, y)$ de l'image $t$
    \item $G$ : un gradient
\end{itemize}
...
Ce qui permet de prendre en compte le temps.
% Temporel
...
\[
    ...
    \end{cases}
\]
où on effectue un différence entre le pixel précédent en $x$ ou $y$ entre l'image suivante et l'image
précédente. On obtiens les contours des objets et des zones de mouvements.
% TODO: images démo ?
...
l'influence du bruit de la séquence vidéo sur notre estimation de mouvement~:
...
Ce qui a l'avantage d'être le plus rapide à l'exécution mais en contrepartie il faut payer le fait qu'aucun autre traitement n'est effectué.
